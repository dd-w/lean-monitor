...
namespace Monitor.Model
{
    public class ResultConverter : IResultConverter
    {
        ...
        public BacktestResult ToBacktestResult(Result result)
        {
            ...
            return new BacktestResult(false, result.Charts.MapToChartDictionary(), result.Orders, result.ProfitLoss, result.Statistics, result.RuntimeStatistics, result.RollingWindow);
        }
        ...
        public LiveResult ToLiveResult(Result result)
        {
            ...
            return new LiveResult(false, result.Charts.MapToChartDictionary(), result.Orders, result.ProfitLoss, null, null, result.Statistics, result.RuntimeStatistics);
        }
    }
}